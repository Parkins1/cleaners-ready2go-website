  ...
  return (
    <section className="py-section bg-white">
      <div className="max-w-6xl mx-auto px-6 sm:px-10 lg:px-12">
        <h2 className="text-3xl lg:text-4xl font-bold text-text mb-xl text-center">Packages for <span className="text-brand-gold">Your Home</span></h2>
        <CarouselCompact items={packages} ariaLabel="Cleaning packages carousel" />
        <p className="text-sm text-text mt-8 text-center max-w-2xl mx-auto">
