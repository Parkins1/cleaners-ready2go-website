    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 p-4 sm:p-5 text-center backdrop-blur-[2px] [text-shadow:0_1px_1px_rgba(0,0,0,0.45)]">
        <div className="max-w-[28ch] sm:max-w-[36ch] mx-auto">
          <div className="bg-accent rounded-full w-20 h-20 mx-auto mb-4 sm:mb-5 flex items-center justify-center shadow-lg transition-transform duration-300 group-hover:scale-110">
            {icon}
          </div>
